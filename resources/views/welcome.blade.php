    ...
    <div class="container">
        <div class="card">
            ...
            <div class="drop_box">
                ...
                <button class="btn" id="chooseFile">Choose File</button>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            let dropArea = document.querySelector(".drop_box"),
                button = document.getElementById("chooseFile"),
            ...
            input.addEventListener("change", function(e) {
                ...
                dropArea.innerHTML = `<h4>Uploading ${fileName}...</h4>`;
                ...
                fetch("{{ route('uploads.store') }}", {
                    ...
                    .then(data => {
                        if (data.success) {
                            dropArea.innerHTML = `<h4>File Uploaded Successfully!</h4>`;

                        } else {
                            dropArea.innerHTML = `<h4>Upload Failed. Try again.</h4>`;
                        }
                    ...
                    .catch(() => dropArea.innerHTML = `<h4>Error uploading file.</h4>`);
            });
        });
    </script>
</body>
